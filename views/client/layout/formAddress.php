                    ...
                    <div class="left-sidebar-checkout sticky">
                            ...
                            <div class="row gy-3">
                                ...
                                <div class="col-sm-6">
                                    <div class="payment-box">
                                        ...
                                        <label for="shipping-<?= $method['id'] ?>"><?= $method['phuong_thuc'] ?></label>
                                    </div>
                                </div>
                                <?php endforeach; ?>
                            </div>
                        ...
                        <div class="address-option">
                            ...
                            <div class="row gy-3">
                                ...
                                <div class="col-sm-6">
                                    <div class="payment-box">
                                        <input class="custom-radio me-2" id="shipping-<?= $method['id'] ?>" type="radio"
                                            name="payment_method" value="<?= $method['id'] ?>"
                                            <?= $index === 0 ? 'checked="checked"' : '' ?>>
                                        <label for="shipping-<?= $method['id'] ?>"><?= $method['name'] ?></label>
                                    </div>
                                </div>
                                <?php endforeach; ?>
                            </div>
...
document.addEventListener("DOMContentLoaded", function() {
    ...
    shippingRadios.forEach(radio => {
        radio.addEventListener('change', function() {
            ...
            // Cập nhật input ẩn total để gửi lên server
